        ...
        <FadeIn delay={0.5}>
          <div className="rounded-4xl border border-foreground/5 bg-foreground/1.5 p-8 sm:p-12 dark:bg-foreground/3">
            <h1 className="font-serif text-[1.75rem] font-medium tracking-tight text-foreground sm:text-[2rem]">
              Hello! I&rsquo;m <span className="border-b border-foreground/30 pb-0.5">Kathiravan A</span>.
            </h1>
            <div className="mt-8 space-y-6 text-[17px] leading-[1.7] tracking-tight text-foreground/75 sm:text-[18px]">
              ...
              <p>
                Currently building projects and expanding my skills in <strong className="font-semibold text-foreground">React, Node.js, Django, and MongoDB</strong>. I&rsquo;m always looking for opportunities to <strong className="font-semibold text-foreground">collaborate on meaningful projects</strong> and grow as a developer.
              </p>
            </div>
          </div>
        </FadeIn>
